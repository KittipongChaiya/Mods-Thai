...
namespace QuasimorphBigPack
{
    ...
    {
        private const string LogFileName = "QuasimorphBigPack.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Big Pack " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphBigPack] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string UniqueName = "QuasimorphBigPack";

        /// <summary>Harmony instance id. Unique per mod, by convention the mod name.</summary>
        internal const string HarmonyId = "QuasimorphBigPack";
    }
}
