...
namespace QuasimorphSilence
{
    ...
    {
        private const string LogFileName = "QuasimorphSilence.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Silence " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphSilence] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string UniqueName = "QuasimorphSilence";
        internal const string HarmonyId = "quasimorph.silence";
    }
}
