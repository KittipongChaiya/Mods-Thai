...
namespace QuasimorphNemesis
{
    ...
    {
        private const string LogFileName = "QuasimorphNemesis.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Nemesis " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphNemesis] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string UniqueName = "QuasimorphNemesis";
        internal const string HarmonyId = "quasimorph.nemesis";
    }
}
