...
namespace QuasimorphComplications
{
    ...
    {
        private const string LogFileName = "QuasimorphComplications.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Complications " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphComplications] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string UniqueName = "QuasimorphComplications";
        internal const string HarmonyId = "quasimorph.complications";
    }
}
