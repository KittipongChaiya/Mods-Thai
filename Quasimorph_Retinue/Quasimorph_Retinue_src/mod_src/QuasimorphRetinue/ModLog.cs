...
namespace QuasimorphRetinue
{
    ...
    {
        private const string LogFileName = "QuasimorphRetinue.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Retinue " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphRetinue] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string UniqueName = "QuasimorphRetinue";

        /// <summary>
        /// The difficulty id the sibling Hardcore Tactical Ruthless mod registers.
        /// Used only as the documented example value for <c>only_on_difficulty</c>;
        /// this mod has no dependency on that one and works without it.
        /// </summary>
        internal const string RuthlessPresetId = "HardcoreTacticalRuthless";
    }
}
