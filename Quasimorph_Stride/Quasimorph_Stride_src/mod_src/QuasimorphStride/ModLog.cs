...
namespace QuasimorphStride
{
    ...
    {
        private const string LogFileName = "QuasimorphStride.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Stride " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphStride] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string UniqueName = "QuasimorphStride";
        internal const string HarmonyId = "quasimorph.stride";
    }
}
