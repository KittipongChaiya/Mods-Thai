...
namespace QuasimorphBigStack
{
    ...
    {
        private const string LogFileName = "QuasimorphBigStack.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Big Stack " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphBigStack] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string HarmonyId = "QuasimorphBigStack";
    }
}
