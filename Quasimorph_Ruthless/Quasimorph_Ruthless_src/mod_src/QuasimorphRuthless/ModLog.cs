...
namespace QuasimorphRuthless
{
    ...
    {
        private const string LogFileName = "QuasimorphRuthless.log";
        ...
        internal static void Start(string modDirectory)
        {
            ...
            Info("=== Quasimorph Hardcore Tactical Ruthless " + ModInfo.Version + " ===");
        ...
        private static void Write(string level, string message)
        {
            ...
            UnityEngine.Debug.Log("[QuasimorphRuthless] " + message);
    ...
    internal static class ModInfo
    {
        ...
        internal const string UniqueName = "QuasimorphRuthless";

        /// <summary>Harmony instance id. Unique per mod, by convention the mod name.</summary>
        internal const string HarmonyId = "QuasimorphRuthless";

        /// <summary>
        /// The key this mod registers in <c>Data.DifficultyPresets</c>. It is also
        /// written into every save made on this difficulty, as
        /// <c>SavedGameMetadata.DifficultyPresetId</c> - see the uninstall note in
        /// the README.
        /// </summary>
        internal const string PresetId = "HardcoreTacticalRuthless";

        /// <summary>The vanilla preset this one is derived from, by delta.</summary>
        internal const string BasePresetId = "Hard";
    }
}
